...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2025 at 04:15 PM
...
(1, 'Dimas Maulana', 'Jakarta', '2003-06-25', 'Laki-Laki', 'Klaten, Jawa Tengah', '+6287889198491', 'dimasmaulana.idn@gmail.com', '681dfcab2cf39.png');
...
(85, 'Graphic Design', 'ETTASHAN3 - Social media design special ramadhan', '681dfcb70b66d.png');
...
--
ALTER TABLE `project`
  MODIFY `project_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
COMMIT;
