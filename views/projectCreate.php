            ...
            <div class="modal-body pt-0">
                <form class="needs-validation" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="photo" name="photo" placeholder="e.g., Graphic Design" required />
                    </div> -->
                    <div class="mb-3">
...
<!-- <div class="mb-3">
	...
	<div class="invalid-feedback">Please upload an image (format: JPG/PNG/WebP)</div>
</div> -->